"""we_pray_20056 URL Configuration
...
admin.site.site_header = "We Pray"
admin.site.site_title = "We Pray Admin Portal"
admin.site.index_title = "We Pray Admin"

# swagger
api_info = openapi.Info(
    title="We Pray API",
    default_version="v1",
    description="API documentation for We Pray App",
)
